...
<html>
  ...
  <body>
  	<div style="width: 100%;border-bottom: dashed 1px #ccc;padding: 5px 0;">
		<span><b>当前位置：场地管理 &gt;租借管理 &gt;新建租借</b></span>
	</div>
    <center>
	<p/>
	<s:form action="fieldrent_rentAdd" method="post" namespace="/" theme="simple"> 
		<table border="0" cellspacing="0" cellpadding="5px" align="center">
			<tr>
				<td >租借人</td>
				<td colspan="3"><s:textfield name="userName" value="username" readonly="true"/></td>
			</tr>
			<tr >
				<td>租借场地:</td>
				<td><s:select name="field.fieldId" list="fieldList" listKey="fieldId" listValue="fieldName" headerKey=""  headerValue="---选择场地---"/></td>
				<td >确认租借？</td>
				<td ><s:select name="rentStatus" list="#{true:'是',false:'让我想想...'}" headerKey=""  headerValue="---选择---"/></td>
			</tr>
			<tr>
				<td >租借时间:</td>
				<td colspan="3"><input type="text" name="rentStartTime"  class="ui_timepicker"  value="" /> 
					<span>到</span><input type="text" name="rentEndTime"  class="ui_timepicker"  value="" /> 
				</td>
			</tr>
			<tr >
				<td >租借用途:</td>
			...
			<tr>
				<td colspan="4" align="center"><s:submit value="租借"/>&emsp;<input type="button" onclick="javascript:return bac();" value="返回"/></td>
			</tr>
		</table>	
	</s:form>
	</center>
