...
<body>
	...
	<div style="width: 100%;padding: 5px 30px 5px 0;" align="right">
		<span><a href="${pageContext.request.contextPath }/jsp/FieldManage/fieldRent/rentIndex.jsp">返回首页</a></span>
	</div>
	<p />
	<center>
		...
		<div style="height: 100px;line-height: 100px;" align="center"><b>修改成功！</b>
		<br/><s:if test="rentStatus == true"><span style="front-size:5 em ;color:red;">使用前请到管理员处缴纳租金<s:property value="field.fieldRentPrice"/>元！</span></s:if>
		</div>
	</center>
</body>
</html>
