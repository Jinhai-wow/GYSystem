	...
	<center>
		<table style="width:100% ; border-top:solid 1px #ccc ;" >
			...
			<tr align="left" height="20px">
				...
				<a href="${pageContext.request.contextPath }/field_toFieldDetail.action?fieldId=<s:property value="#f.fieldId"/>" target="main" >详细</a>&emsp;
				<!-- 管理员权限 --><a href="${pageContext.request.contextPath }/field_toFieldUpdate.action?fieldId=<s:property value="#f.fieldId"/>" target="main">更新</a>&emsp;
				<!-- 管理员权限 --><a href="${pageContext.request.contextPath }/field_wantDelete.action?fieldId=<s:property value="#f.fieldId"/>" target="fieldMain" onclick="javascript: return del();">删除</a></td>
			</tr>
			</s:iterator>
			<tr>
				<td align="right" colspan="6" >
					...
					<s:if test="currPage != 1">
						<a href="${pageContext.request.contextPath }/field_findAll.action?currPage=1">首页</a>&nbsp;
						<a href="${pageContext.request.contextPath }/field_findAll.action?currPage=<s:property value="currPage-1"/>">上一页</a>&nbsp;
					</s:if>
					<s:if test="currPage != pageCount">
						<a href="${pageContext.request.contextPath }/field_findAll.action?currPage=<s:property value="currPage+1"/>">下一页</a>&nbsp;
						<a href="${pageContext.request.contextPath }/field_findAll.action?currPage=<s:property value="pageCount"/>">尾页</a>&emsp;
					</s:if>
					</span>
				</td>
			</tr>
