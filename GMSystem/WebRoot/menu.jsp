							...
							<TBODY>
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_1');"><SPAN
										class=span id=table_1Span>＋</SPAN> 场地管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/jsp/FieldManage/fieldIndex.jsp" 
														target=main>－ 基本管理</A></TD>
												</TR>
												<TR> 
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/jsp/FieldManage/fieldRent/rentIndex.jsp"
														target=main>－ 场地租借</A></TD>
												</TR>
												<TR> 
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/jsp/FieldManage/fieldMiss/missIndex.jsp"
														target=main>－ 租借失约</A></TD>
												</TR>
												<TR> 
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/jsp/FieldManage/fieldSave/saveIndex.jsp"
														target=main>－ 场地维护</A></TD>
												</TR>
