	...
	<center>
		<table style="width:100% ;border-top:solid 1px #ccc;">
			<tr align="left" height="20px">
				...
				<td background=${pageContext.request.contextPath }/images/new_20.png>赛事ID</td>
			...
			<s:iterator value="list" var="r">
				<tr align="left" height="20px">
					<td style="width: 20%;border:solid 1px #ccc ;">&emsp;<s:property
							value="#r.rentNomber" /></td>
					<td style="width: 20%;border:solid 1px #ccc ;"><s:property
							value="#r.eventList" /></td>
					<td style="width: 20%;border:solid 1px #ccc ;"><s:property
							value="#r.field.fieldName" /></td>
					...
					<a href="${pageContext.request.contextPath }/fieldrent_toRentDetail.action?fieldRentId=<s:property value="#r.fieldRentId"/>"
						target="main">详细</a>&emsp; 
					<!-- 管理员权限 --><a href="${pageContext.request.contextPath }/fieldrent_toRentUpdate.action?fieldRentId=<s:property value="#r.fieldRentId"/>"
						target="main">更新</a>&emsp; 
					<!-- 管理员权限 --><a href="${pageContext.request.contextPath }/fieldrent_wantDelete.action?fieldRentId=<s:property value="#r.fieldRentId"/>"
