		...
		<table style="width:100% ;border-top:solid 1px #ccc;">
			...
			<s:iterator value="list" var="s">
			 <tr align="left" height="20px">
				...
				<a href="${pageContext.request.contextPath }/fieldsave_wantDelete.action?fieldSaveId=<s:property value="#s.fieldSaveId"/>" target="fieldMain" onclick="javascript:return del();">删除</a></td>
			</tr>
			</s:iterator>
			<tr>
